        ...
        <div className="flex w-full justify-center">
          <div className="flex h-full w-[34rem] cursor-pointer items-center justify-between rounded-lg border border-gray-300 bg-[#fff] px-3 lg:py-4 py-1">
            <div className="flex items-center gap-3">
              <div className="flex items-center lg:w-full font-bold gap-1 text-xs lg:text-base whitespace-nowrap">
                <span>Loan</span>
              ...
              <span className="block lg:hidden whitespace-wrap text-xs">
