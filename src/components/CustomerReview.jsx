...
//       <div className="flex w-full max-w-6xl flex-col flex-initial justify-center items-center px-4">
//         <div className="pt-16 pb-8 font-semibold">
//           <h1 className="text-[32px] font-bold text-white">Customer reviews</h1>
//         </div>
...
//               <div
//                 key={i + startIndex}
//                 className="p-6 bg-white rounded-lg shadow-md transition-all duration-500 ease-in-out flex flex-col min-h-[300px]" // Ensure consistent height
//               >
//                 <FaQuoteLeft className="text-[#EE5A30] text-2xl" />

//                 {/* Content Wrapper with Flex to push Name to Bottom */}
//                 <div className="flex flex-col flex-grow justify-between">
//                   <p className="mt-4 text-gray-800">{review.text}</p>

//                   {/* Name should always stay at the bottom */}
//                   <p className="text-gray-500 mt-4 self-start">{review.name}</p>
//                 </div>
//               </div>
//             ))}
//           </div>
...
const CustomerReview = () => {
  ...
  return (
    <div className="flex items-center justify-center w-full bg-[#fa6237]">
      <div className="flex w-full max-w-6xl flex-col justify-center items-center px-4">
        <div className="pt-16 pb-8 font-semibold">
          <h1 className="text-[32px] font-bold text-white">Customer reviews</h1>
        </div>
